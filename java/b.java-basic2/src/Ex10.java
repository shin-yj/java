...
public class Ex10 {
	...
	public static void main(String[] args) {
		...
		str1 = new String("Hello"); // new -> 새로운 공간
		str2 = new String("Hello");
		System.out.println("3." + str1.equals(str2)); //true
		System.out.println("4." + (str1 == str2)); // 이 때 false
		
		//2. 고정 문자열 -> 문자열 더할 수 없다
		String str3 = new String("Original String");
		String str4 = str3;
		str4 = str4 + "Attached String";
		System.out.println(str3 == str4);
		System.out.println(str3);
		System.out.println("------------"); // original string만 나옴
		
		//3. 가변 문자열 -> 문자열 더할 수 있다
		//StringBuilder sb = new StringBuilder(36); // Stringbuilder는 주어진 문자열 내에서 수정 가능
